...
class UserInfo:
    ...
    def info_embed(self, interaction: discord.Interaction, discord_user: discord.User):
        with db_conn() as db:
            db.execute(
...
class Informational(commands.Cog):
    ...
    async def info(
        ...
        embed = UserInfo.info_embed(
            self, interaction=interaction, discord_user=discord_user
        )
